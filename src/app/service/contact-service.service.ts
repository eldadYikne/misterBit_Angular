...
export class ContactService {
  //mock the server
  private _contactsDb: Contact[] = storageService.loadFromStorage('contactDB')||CONTACTS;
  ...
  public loadContacts(): void {
    let contacts = storageService.loadFromStorage('contactDB') || this._contactsDb;
    storageService.saveToStorage('contactDB', contacts)
  ...
  private _updateContact(contact: Contact) {
    ...
    // change the observable data in the service - let all the subscribers know
    storageService.saveToStorage('contactDB', this._contactsDb)
